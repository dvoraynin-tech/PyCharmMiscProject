try:
    ...
    f1.write("Це текст з файлу TF18_1: Панич хутенько вбрався і вийшов на місто. Він вийшов на найбільшу вулицю, тихо проходив біля магазинів та роздивлявся по вітринах. Ні, не може, не може він нічого знайти «достойного». А, ось ювелірний магазин, – може, тут? Він пильніше почав придивлятись. ")
    f1.close()
except:
...
try:
    ...
    f2.write("Це текст з файлу TF18_2: «Он цілий рядок брошок. Он досить гарненька, і ще й з якимсь написом, що ж то? Amore!.. Ні, се не підходить. Он серце з стрілою, – надто сентиментально. ")
    f2.close()
except:
